      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        <form onSubmit={emailForm.handleSubmit}>
          <div className="py-2 w-full">
            To log in, submit your email address. If an account matches that
            address, you'll get sent a one time Pass good for the next 15
            minutes. Already have a Pass? Click here to use it.
          </div>
          <div className="py-2 w-full">
            <Input
